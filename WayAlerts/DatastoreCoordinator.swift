...
*/
class DatastoreCoordinator1: NSObject {
    
    private let objectModelName = "WayAlertsCoreModel"
    private let objectModelExtension = "momd"
    private let dbFilename = "WayAlertsCoreData.sqlite"
    private let appDomain = "com.smt.WayAlerts"
